...
const EXPORTER_COLUMNS: Column<ExporterScrape>[] = [
  ...
  { key: "kind", title: "Kind", width: 100, min: 60, value: (e) => e.kind, render: (e) => <span className="gpuext-badge">{e.kind === "dcgm" ? "dcgm-exporter" : "per-process"}</span> },
  { key: "node", title: "Node", width: 220, min: 80, value: (e) => e.nodeName, className: "gpuext-dim" },
  { key: "latency", title: "Scrape", width: 90, min: 60, num: true, value: (e) => e.latencyMs ?? -1, render: (e) => (e.latencyMs === undefined ? "–" : `${e.latencyMs} ms`) },
  { key: "bytes", title: "Body", width: 90, min: 60, num: true, value: (e) => e.bytes ?? -1, render: (e) => (e.bytes === undefined ? "–" : `${(e.bytes / 1024).toFixed(0)} KiB`) },
    ...
    <PageShell
      ...
      subtitle={
        <>
          ...
          dcgm, gpu, nvidia or cuda, probes each <code>/metrics</code> through the apiserver pod-proxy and classifies
          by content. Discovery is cached for 60 s; Refresh re-runs it.
        </>
      }
    >
